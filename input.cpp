...
//   関数宣言
//==============================
static bool InitInput(HINSTANCE hInstance);
...
bool InitKeyboard(HINSTANCE hInstance, HWND hWnd)
{
	...
	{
		MessageBox(hWnd, "キーボードが存在しません。", "警告！", MB_ICONWARNING);
		return false;
	}
...
//=============================================================================================================
//   キー(引数）を入力したら
//  （何かしらの書き換え・Uninitがない限りずっとキー（引数）が入力された状態がつづくので注意）
//==============================================================================================================
...
//  ゲームパッド入力初期化処理
//==============================
bool InitGamePad(HINSTANCE hInstance, HWND hWnd)
{
	if (!InitInput(hInstance)) 
	{
		MessageBox(hWnd, "DirectInputオブジェクトが作れませんでした。", "警告！", MB_ICONWARNING);
